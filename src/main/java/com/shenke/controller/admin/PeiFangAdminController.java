...
public class PeiFangAdminController {
     ...
     * @return
     */
    @RequestMapping("/findByinformNumber")
    public Map<String,Object> findByinformNumber(Long infromNumber){
        Map<String,Object> map = new HashMap<>();
        map.put("rows",peiFangService.findByinformNumber(infromNumber));
        return map;
    }
